...
before packages are loaded."
  ;; Active SQL source code blocks in emacs
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-babel-eval-in-repl random-splash-image rubocopfmt lsp-ui company-lsp lsp-mode yaml-mode ws-butler winum which-key web-mode web-beautify volatile-highlights vimrc-mode vi-tilde-fringe uuidgen use-package unfill toc-org tern tagedit symon string-inflection spaceline-all-the-icons smeargle slim-mode seeing-is-believing scss-mode sass-mode rvm ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocop rspec-mode robe rjsx-mode reveal-in-osx-finder restart-emacs react-snippets rbenv rainbow-delimiters pug-mode projectile-rails prettier-js popwin persp-mode password-generator paradox ox-gfm osx-trash osx-dictionary orgit org-projectile org-present org-pomodoro org-mime org-download org-bullets org-brain open-junk-file neotree mwim move-text mmm-mode minitest markdown-toc magit-svn magit-gitflow lorem-ipsum livid-mode link-hint launchctl json-navigator json-mode js2-refactor js-doc indent-guide impatient-mode hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation helm-xref helm-themes helm-swoop helm-purpose helm-projectile helm-mode-manager helm-make helm-gitignore helm-flx helm-descbinds helm-css-scss helm-ag google-translate golden-ratio gnuplot gitignore-templates gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ gh-md font-lock+ flycheck-pos-tip flx-ido flow-minor-mode fill-column-indicator feature-mode fancy-battery eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-org evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-cleverparens evil-args evil-anzu eval-sexp-fu emmet-mode editorconfig dumb-jump dotenv-mode diminish diff-hl dactyl-mode counsel-projectile copy-as-format column-enforce-mode clean-aindent-mode chruby centered-cursor-mode bundler browse-at-remote auto-highlight-symbol apib-mode aggressive-indent add-node-modules-path ace-window ace-link ace-jump-helm-line))))
(custom-set-faces
